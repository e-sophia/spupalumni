<main id="main">
                ...
                <div class="col-xl-7 d-flex align-items-stretch order-2 order-lg-1">
                    <div class="content d-flex flex-column justify-content-center">
                        ...
                        <div class="col-md-6 icon-box" data-aos="fade-up">
                            ...
                            <h4>YEARBOOK</h4>
                            <p>Capture and cherish your memories with our beautifully crafted yearbooks, featuring highlights and moments that matter.</p>
                        </div>
                        <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                            <i class="bx bx-cube-alt"></i>
                            <h4>PACKAGES</h4>
                            <p>Explore our comprehensive packages tailored to meet your specific needs, offering a variety of options to choose from.</p>
                        </div>
                        <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                            <i class="bx bx-receipt"></i>
                            <h4>RESUME</h4>
                            <p>Get professional resume services to enhance your job search, showcasing your skills and experiences effectively.</p>
                        </div>
                        <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
                            <i class="bx bx-shield"></i>
                            <h4>Events & Homecomings</h4>
                            <p>Join us for memorable events and homecomings that celebrate our community and create lasting connections.</p>
                        </div>
                        <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
                            <i class="bx bx-globe"></i>
                            <h4>Our Global Network</h4>
                            <p>Connect with our extensive global network of alumni, fostering professional and personal growth opportunities.</p>
                        </div>
                        <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
                            <i class="bx bx-id-card"></i>
                            <h4>Alumni Card Partners</h4>
                            <p>Enjoy exclusive benefits and discounts through our partnerships with various alumni card partners.</p>
                        </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="gallery" class="gallery">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                <h2>Gallery</h2>
                <p>Explore the achievements and memories of our alumni through this collection. 
                    Celebrate their successes and relive special moments from past events.</p>
            </div>
        </div>
